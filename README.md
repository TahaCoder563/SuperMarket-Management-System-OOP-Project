...
class User{
    ...
    void bill(int f){
        if (f==0 || f==2)
        {
            ...
            cout<<"  "<<"Product Id "<<setw(25)<<"Product Name"<<setw(25)<<"Product Quantity"<<setw(25)<<"Product Cost"<<endl;
...
class delivery_on_call{
    ...
    void buy(){
        ...
        cout<<"Dialing in 20 seconds"<<endl;
        ...
        if (a==1)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                cout << s2.electronic_products[i].get_product_name() << endl;
            }
            cin>>b;
            while (b>s2.num_of_electronic_items && b>=0)
            {
            ...
            for (int i = 0; i < 3; i++)
            {
                cout<<s2.snacks_products[i].get_product_name()<<endl;
            }
            cin>>b;
            while (b>s2.num_of_snack_items && b>=0)
            {
            ...
            for (int i = 0; i < 3; i++)
            {
                cout << s2.stationary_products[i].get_product_name() << endl;
            }
            cin>>b;
            while (b>s2.num_of_stationary_items && b>=0)
            {
